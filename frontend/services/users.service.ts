...
export const usersService = {
  ...
  assignTeam:    (userId: string, teamId: string) => api.put<AssignTeamApiResponse>(`/users/${userId}/team`, { teamId }),
  updateRole:    (userId: string, role: UserProfile['role']) => api.put<UpdateRoleApiResponse>(`/users/${userId}/role`, { role }),
  deleteUser:    (userId: string) => api.delete<DeleteUserApiResponse>(`/users/${userId}`),
